...
FIGURE_PATH = FIGURE_DIR / "cusum_vs_bocd.png"
...
def create_comparison_plot():
    ...
    years = results["year"].to_numpy()

    cases = results["cases"].to_numpy()

    cusum_alarm = results["cusum_alarm"].to_numpy()

    expected_run_length = results["bocd_expected_run_length"].to_numpy()
    ...
    ax1.set_title("Annual measles surveillance counts")
    ...
    ax2.set_ylabel("Expected run length")

    ax2.set_title("Bayesian Online Change-Point Detection")
